...
// import cross_icon from "../Admin_Assets/cross_icon.png"; // Fixed import
...
//     try {
//       const response = await fetch('http://localhost:510/allproducts'); // Fixed URL
...
//           <p>{product.category}</p> {/* Fixed typo */}
//           <img onClick={()=>{remove_product(product._id)}}
